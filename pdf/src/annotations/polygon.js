...
(function(){
    ...
    */
    ...
    CAnnotationPolygon.prototype.Draw = function(oGraphicsPDF, oGraphicsWord) {
        this.DrawFromStream(oGraphicsPDF);
    };
    CAnnotationPolygon.prototype.IsNeedDrawFromStream = function() {
        return true;
    };
    CAnnotationPolygon.prototype.DrawBackground = function() {
        return;
    };
    CAnnotationPolygon.prototype.GetDrawing = function() {
        return this.content.GetAllDrawingObjects()[0];
    };
    CAnnotationPolygon.prototype.GetShapeInkMargins = function(bInMM) {
    ...
    CAnnotationPolygon.prototype.SetInkPoints = function(aSourcePaths) {
        let oViewer         = editor.getDocumentRenderer();
    ...
    CAnnotationPolygon.prototype.AddShapeByPoints = function(aPoints, oPen) {
        let oViewer         = editor.getDocumentRenderer();
        let oDoc            = oViewer.getPDFDoc();
        let oDrDoc          = oDoc.GetDrawingDocument();
    ...
    CAnnotationPolygon.prototype.SetFlipV = function(bFlip) {
        let oDoc = this.GetDocument();
        let oGraphicObj = this.GetDrawing().GraphicObj;
    ...
    CAnnotationPolygon.prototype.SetFlipH = function(bFlip) {
        let oDoc = this.GetDocument();
        let oGraphicObj = this.GetDrawing().GraphicObj;
    ...
    CAnnotationPolygon.prototype.AddPath = function(aNewPath) {
        let oDoc = this.GetDocument();
    ...
    CAnnotationPolygon.prototype.RemoveLastAddedPath = function() {
        let nLineW = this.GetWidth() * g_dKoef_pt_to_mm * g_dKoef_mm_to_pix;
    ...
    CAnnotationPolygon.prototype.RefillGeometry = function(oGeometry, aBounds) {
    ...
    CAnnotationPolygon.prototype.Copy = function() {
        ...
        let oNewInk = new CAnnotationPolygon(AscCommon.CreateGUID(), this.GetPage(), this.GetRect().slice(), oDoc);
    ...
    CAnnotationPolygon.prototype.GetRelativePaths = function() {
    ...
    CAnnotationPolygon.prototype.SetOpacity = function(value) {
        this._opacity = value;
        this.SetWasChanged(true);
    ...
    CAnnotationPolygon.prototype.GetStrokeColor = function() {
    ...
    CAnnotationPolygon.prototype.GetWidth = function() {
        return this._width;
    };
    
    CAnnotationPolygon.prototype.IsSelected = function() {
        let oViewer         = editor.getDocumentRenderer();
        let oDrawingObjects = oViewer.DrawingObjects;
        return oDrawingObjects.selectedObjects.includes(this);
    };
    CAnnotationPolygon.prototype.SetDrawing = function(oDrawing) {
    ...
    CAnnotationPolygon.prototype.getTransformMatrix = function() {
        return this.GetDrawing().GraphicObj.getTransformMatrix();
    };
    CAnnotationPolygon.prototype.canRotate = function() {
        return false; // to сделать вращение
    };
    CAnnotationPolygon.prototype.canEdit = function() {
        true;
    };
    CAnnotationPolygon.prototype.canChangeAdjustments = function() {
        return this.GetDrawing().GraphicObj.canChangeAdjustments();
    };
    CAnnotationPolygon.prototype.hitToAdjustment = function() {
    ...
    CAnnotationPolygon.prototype.hitToHandles = function(x, y) {
        return this.GetDrawing().GraphicObj.hitToHandles.call(this, x, y);
    };
    CAnnotationPolygon.prototype.hitInBoundingRect = function() {
        return this.GetDrawing().GraphicObj.hitInBoundingRect();
    };
    CAnnotationPolygon.prototype.getCardDirectionByNum = function(num) {
        return this.GetDrawing().GraphicObj.getCardDirectionByNum(num);
    };
    CAnnotationPolygon.prototype.hitInInnerArea = function(x, y) {
        return this.GetDrawing().GraphicObj.hitInInnerArea(x, y);
    };
    CAnnotationPolygon.prototype.hitInPath = function(x, y) {
        return this.GetDrawing().GraphicObj.hitInPath(x, y);
    };
    CAnnotationPolygon.prototype.hitInTextRect = function(x, y) {
        return this.GetDrawing().GraphicObj.hitInTextRect(x, y);
    };
    CAnnotationPolygon.prototype.getCNvProps = function(x, y) {
        return this.GetDrawing().GraphicObj.getCNvProps(x, y);
    };
    CAnnotationPolygon.prototype.canResize = function() {
        return true;
    };
    CAnnotationPolygon.prototype.select = function(drawingObjectsController, pageIndex) {
        this.selected = true;
    ...
    CAnnotationPolygon.prototype.canMove = function() {
        return true;
    };
    CAnnotationPolygon.prototype.createResizeTrack = function (cardDirection, oController) {
        return new AscFormat.ResizeTrackShapeImage(this, cardDirection, oController);
    };
    CAnnotationPolygon.prototype.getNumByCardDirection = function (cardDirection) {
        return this.GetDrawing().GraphicObj.getNumByCardDirection(cardDirection);
    };
    CAnnotationPolygon.prototype.getTrackGeometry = function () {
        return this.GetDrawing().GraphicObj.getTrackGeometry();
    };
    CAnnotationPolygon.prototype.createMoveTrack = function() {
        return new AscFormat.MoveAnnotationTrack(this);
    };
    CAnnotationPolygon.prototype.getResizeCoefficients = function(handleNum, x, y) {
        return this.GetDrawing().GraphicObj.getResizeCoefficients(handleNum, x, y);
    };
    CAnnotationPolygon.prototype.isObjectInSmartArt = function() {
        return false;
    };
    CAnnotationPolygon.prototype.getNoChangeAspect = function() {
        return this.GetDrawing().GraphicObj.getNoChangeAspect();
    };
    CAnnotationPolygon.prototype.setSpPr = function(oPr) {
        return this.GetDrawing().GraphicObj.setSpPr(oPr);
    };
    CAnnotationPolygon.prototype.ResetParametersWithResize = function() {
        return this.GetDrawing().GraphicObj.ResetParametersWithResize();
    };
    CAnnotationPolygon.prototype.checkDrawingBaseCoords = function() {
        return this.GetDrawing().GraphicObj.checkDrawingBaseCoords();
    };
    CAnnotationPolygon.prototype.getAspect = function() {
        return this.GetDrawing().GraphicObj.getAspect();
    };
    CAnnotationPolygon.prototype.createRotateTrack = function() {
        return new AscFormat.RotateTrackShapeImage(this);
    };
    CAnnotationPolygon.prototype.getRotateAngle = function() {
        return this.GetDrawing().GraphicObj.getRotateAngle();
    };
    CAnnotationPolygon.prototype.getFullFlipH = function() {
        return this.GetDrawing().GraphicObj.getFullFlipH();
    };
    CAnnotationPolygon.prototype.getFullFlipV = function() {
        return this.GetDrawing().GraphicObj.getFullFlipV();
    };
    CAnnotationPolygon.prototype.changeRot = function(angle, bWord) {
        return this.GetDrawing().GraphicObj.changeRot(angle, bWord);
    };
    CAnnotationPolygon.prototype.getInvertTransform = function() {
        return this.GetDrawing().GraphicObj.getInvertTransform();
    };
    CAnnotationPolygon.prototype.convertPixToMM = function(px) {
