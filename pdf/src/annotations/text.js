...
(function(){
    ...
    */
    ...
    const ICON_CHECK = new Image();
    ICON_CHECK.src = `data:image/svg+xml;utf8,${encodeURIComponent(SVG_ICON_CHECK)}`;
    ...
    const ICON_CROSS = new Image();
    ICON_CROSS.src = `data:image/svg+xml;utf8,${encodeURIComponent(SVG_ICON_CROSS)}`;
    ...
    const ICON_HELP = new Image();
    ICON_HELP.src = `data:image/svg+xml;utf8,${encodeURIComponent(SVG_ICON_HELP)}`;
    ...
    const ICON_INSERT = new Image();
    ICON_INSERT.src = `data:image/svg+xml;utf8,${encodeURIComponent(SVG_ICON_INSERT)}`;
    ...
    const ICON_KEY = new Image();
    ICON_KEY.src = `data:image/svg+xml;utf8,${encodeURIComponent(SVG_ICON_KEY)}`;
    ...
    const ICON_NEW_PARAGRAPH = new Image();
    ICON_NEW_PARAGRAPH.src = `data:image/svg+xml;utf8,${encodeURIComponent(SVG_ICON_NEW_PARAGRAPH)}`;
    ...
    const ICON_PARAGRAPH = new Image();
    ICON_PARAGRAPH.src = `data:image/svg+xml;utf8,${encodeURIComponent(SVG_ICON_PARAGRAPH)}`;
    ...
    const ICON_RIGHT_ARROW = new Image();
    ICON_RIGHT_ARROW.src = `data:image/svg+xml;utf8,${encodeURIComponent(SVG_ICON_RIGHT_ARROW)}`;
    ...
    const ICON_RIGHT_POINTER = new Image();
    ICON_RIGHT_POINTER.src = `data:image/svg+xml;utf8,${encodeURIComponent(SVG_ICON_RIGHT_POINTER)}`;
    ...
    const ICON_STAR = new Image();
    ICON_STAR.src = `data:image/svg+xml;utf8,${encodeURIComponent(SVG_ICON_STAR)}`;
    ...
    ICON_NOTE.src = `data:image/svg+xml;utf8,${encodeURIComponent(SVG_ICON_NOTE)}`;
    ...
    const ICON_UP_ARROW = new Image();
    ICON_UP_ARROW.src = `data:image/svg+xml;utf8,${encodeURIComponent(SVG_ICON_UP_ARROW)}`;
    ...
    const ICON_UP_LEFT_ARROW = new Image();
    ICON_UP_LEFT_ARROW.src = `data:image/svg+xml;utf8,${encodeURIComponent(SVG_ICON_UP_LEFT_ARROW)}`;
    ...
    let NOTE_ICONS_IMAGES = {
        ...
        Insert:         ICON_INSERT,
        Key:            ICON_KEY,
        NewParagraph:   ICON_NEW_PARAGRAPH,
        Note:           ICON_NOTE,
        Paragraph:      ICON_PARAGRAPH,
        RightArrow:     ICON_RIGHT_ARROW,
        RightPointer:   ICON_RIGHT_POINTER,
        Star:           ICON_STAR,
        UpArrow:        ICON_UP_ARROW,
        UpLeftArrow:    ICON_UP_LEFT_ARROW
    }
})();
