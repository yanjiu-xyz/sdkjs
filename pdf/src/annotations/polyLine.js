...
(function(){
    ...
    */
    ...
    CAnnotationPolyLine.prototype.CreateMoveTrack = function() {
        return new AscFormat.MoveAnnotationTrack(this);
    };
    CAnnotationPolyLine.prototype.SetDrawing = function(oDrawing) {
        let oRun = this.content.GetElement(0).GetElement(0);
        oRun.Add_ToContent(oRun.Content.length, oDrawing);
    };
    
    CAnnotationPolyLine.prototype.onMouseUp = function() {
        let oViewer = editor.getDocumentRenderer();
