...
CT_pivotTableDefinition.prototype.getItemsIndexesByItemFieldsMap = function(itemFieldsMap) {
	...
	let rowItemIndex = rowItems && rowItems.length - 1;
	if (rowItemFieldsMap) {
	...
	let colItemIndex = colItems && colItems.length - 1;
	if (colItemFieldsMap) {
...
CT_pivotTableDefinition.prototype.getItemFieldsMapByGetPivotDataParams = function(params) {
	...
	const optParams = params.optParams ? this.getPivotDataOptParams(params.optParams) : null;
	if (optParams === null) {
		return null;
	};
