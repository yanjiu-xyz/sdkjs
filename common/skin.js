...
function updateGlobalSkinColors(theme)
{
	...
	var colorMap = {
		...
		AnimPaneEffectBarFillEntrance       : "anim-pane-effect-bar-entrance-fill",
		AnimPaneEffectBarOutlineEntrance    : "anim-pane-effect-bar-entrance-outline",
		AnimPaneEffectBarFillEmphasis       : "anim-pane-effect-bar-emphasis-fill",
		AnimPaneEffectBarOutlineEmphasis    : "anim-pane-effect-bar-emphasis-outline",
		...
		AnimPaneTimelineScrollerFill           : "anim-pane-timeline-scroller-fill",
		AnimPaneTimelineScrollerOutline        : "anim-pane-timeline-scroller-outline",
		AnimPaneTimelineScrollerOpacity        : "anim-pane-timeline-scroller-opacity",
		AnimPaneTimelineScrollerOpacityHovered : "anim-pane-timeline-scroller-opacity-hovered",
		AnimPaneTimelineScrollerOpacityActive  : "anim-pane-timeline-scroller-opacity-active",
