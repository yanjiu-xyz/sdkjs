...
function updateGlobalSkinColors(theme)
{
	...
	var colorMap = {
		...
		AnimPanePlayButtonFill              : 'anim-pane-plaay-button-fill',
		AnimPanePlayButtonOutline           : 'anim-pane-plaay-button-ouline',
		...
		AnimPaneEffectBarOutlinePath        : 'anim-pane-effect-bar-path-ouline',
