...
var EditorSkins = {
	"theme-light" : {
		...
		AnimPaneEffectBarFillEntranceActive    : "#5F9169",
		AnimPaneEffectBarOutlineEntrance       : "#0E8A26",
		AnimPaneEffectBarOutlineEntranceActive : "#0B4E1E",
		AnimPaneEffectBarFillEmphasis          : "#FBC37C",
		AnimPaneEffectBarFillEmphasisActive    : "#C99C63",
		AnimPaneEffectBarOutlineEmphasis       : "#FF8E00",
		AnimPaneEffectBarOutlineEmphasisActive : "#CC7200",
		AnimPaneEffectBarFillExit              : "#F59A9A",
		AnimPaneEffectBarFillExitActive        : "#C47B7B",
		AnimPaneEffectBarOutlineExit           : "#F23D3D",
		AnimPaneEffectBarOutlineExitActive     : "#C23131",
		AnimPaneEffectBarFillPath              : "#A1CEE3",
		AnimPaneEffectBarFillPathActive        : "#81A5B6",
		AnimPaneEffectBarOutlinePath           : "#254662",
		AnimPaneEffectBarOutlinePathActive     : "#1E384E",
...
function updateGlobalSkinColors(theme)
{
	...
	var colorMap = {
		...
		AnimPaneEffectBarFillEntranceActive    : "canvas-anim-pane-effect-bar-entrance-fill-active",
		AnimPaneEffectBarOutlineEntrance       : "canvas-anim-pane-effect-bar-entrance-outline",
		AnimPaneEffectBarOutlineEntranceActive : "canvas-anim-pane-effect-bar-entrance-outline-active",
		AnimPaneEffectBarFillEmphasis          : "canvas-anim-pane-effect-bar-emphasis-fill",
		AnimPaneEffectBarFillEmphasisActive    : "canvas-anim-pane-effect-bar-emphasis-fill-active",
		AnimPaneEffectBarOutlineEmphasis       : "canvas-anim-pane-effect-bar-emphasis-outline",
		AnimPaneEffectBarOutlineEmphasisActive : "canvas-anim-pane-effect-bar-emphasis-outline-active",
		AnimPaneEffectBarFillExit              : "canvas-anim-pane-effect-bar-exit-fill",
		AnimPaneEffectBarFillExitActive        : "canvas-anim-pane-effect-bar-exit-fill-active",
		AnimPaneEffectBarOutlineExit           : "canvas-anim-pane-effect-bar-exit-outline",
		AnimPaneEffectBarOutlineExitActive     : "canvas-anim-pane-effect-bar-exit-outline-active",
		AnimPaneEffectBarFillPath              : "canvas-anim-pane-effect-bar-path-fill",
		AnimPaneEffectBarFillPathActive        : "canvas-anim-pane-effect-bar-path-fill-active",
		AnimPaneEffectBarOutlinePath           : "canvas-anim-pane-effect-bar-path-outline",
		AnimPaneEffectBarOutlinePathActive     : "canvas-anim-pane-effect-bar-path-outline-active",
