...
$(function ()
{
	...
	QUnit.test("Test the numbering specified in a style", function (assert)
	{
		...
		// MSWord так не делает. В MSWord если не задан уровнь, значит уровень = 0
		//--------------------------------------------------------------------------------------------------------------
		...
		// с текущим уровнем, то нумерация добавляется именно для подошедшего стиля. https://bugzilla.onlyoffice.com/show_bug.cgi?id=51893
		//--------------------------------------------------------------------------------------------------------------
